                                              ...
                                              var_6:lvm_operand_opr,var_7:lvm_operand_opr,var_8:lvm_operand_opr,var_11:lvm_operand_opr,var_12:lvm_operand_opr):lvm_code
{
    ...
    lvm_Block(lvm_CCons(Ins(GETELEMENTPTR(var_5,1,var_0,index3)),                         // %5 = getelementptr inbounds i8, i8* %0, i64 3
              ...
              lvm_CCons(Ins(ICMP(var_17,sgt,4,speed_value,D(Int(0,IntType(4,false))))),   // %17 = icmp sgt i32 %13, 0 
...
// POST Conditions
  ...
  ensures lvm_sM.ok ==> ValidStateSeq(lvm_sMs);
  {
    ...
    ghost var lvm_b10, lvm_s10:= lvm_lemma_Icmp(lvm_b9, lvm_s9, lvm_sM, var_17,sgt,4,speed_value,D(Int(0,IntType(4,false))));
    ...
    assert OperandContents(lvm_s9,speed_value).val > 0 ==> OperandContents(lvm_s10,var_17).val == 1; // <-- Proof Breaks here ie. Vulnerability 
