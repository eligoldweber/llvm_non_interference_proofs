...
function {:opaque} Bitwise16CastTo8(x:uint16):uint8
{
    x  % 0x100
}
function {:opaque} Bitwise32CastTo8(x:uint32):uint8
{
    x  % 0x100
}
function {:opaque} Bitwise64CastTo8(x:uint64):uint8
{
    x  % 0x100
}
function {:opaque} Bitwise128CastTo8(x:uint128):uint8
{
    x  % 0x100
}
//
...
function {:opaque} Bitwise32CastTo16(x:uint32):uint16
{
    x  % 0x1000
}
function {:opaque} Bitwise64CastTo16(x:uint64):uint16
{
    x  % 0x1000
}
function {:opaque} Bitwise128CastTo16(x:uint128):uint16
{
    x  % 0x1000
}
//
...
function {:opaque} Bitwise64CastTo32(x:uint64):uint32
{
    x  % 0x1_0000_0000
}
function {:opaque} Bitwise128CastTo32(x:uint128):uint32
{
    x  % 0x1_0000_0000
}
//
...
function {:opaque} Bitwise128CastTo64(x:uint128):uint64
{
    x  % 0x1_0000_0000_0000_0000
}
//
